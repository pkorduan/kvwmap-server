# Supported tags and respective Dockerfile
    ...
    * 2.2.20 [docker/2.2.20/Dockerfile](https://github.com/pkorduan/kvwmap-server/blob/master/docker/2.2.20/Dockerfile)
    * 2.2.19 [docker/2.2.19/Dockerfile](https://github.com/pkorduan/kvwmap-server/blob/master/docker/2.2.19/Dockerfile)
    * 2.2.18 [docker/2.2.18/Dockerfile](https://github.com/pkorduan/kvwmap-server/blob/master/docker/2.2.18/Dockerfile)
    * 2.2.17 [docker/2.2.17/Dockerfile](https://github.com/pkorduan/kvwmap-server/blob/master/docker/2.2.17/Dockerfile)
...
# Changelog
# 2.2.20
    * ca-certificates updaten und /etc/environment aktualisieren 
# 2.2.19
    * php 7.4 
# 2.2.16
